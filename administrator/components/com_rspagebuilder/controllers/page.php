		...
		if (!empty($row_options_fields)) {
			...
			if (!empty($basic_fields)) {
				...
				foreach ($basic_fields as $basic_field) {
					...
					if ($form->getFieldAttribute($basic_field, 'type') == 'hidden') {
						$html .= ' hidden';
					}
					$html .= '">';
					$html .= '<div class="control-label">';
					$html .= $form->getLabel($basic_field);
					$html .= '</div>';
					$html .= '<div class="controls">';
					$html .= $form->getInput($basic_field);
					$html .= '</div>';
					$html .= '</div>';
				}
				$html .= '</div>';
			...
			if (!empty($size_fields)) {
				...
				foreach ($size_fields as $size_field) {
					...
					if ($form->getFieldAttribute($size_field, 'type') == 'hidden') {
						$html .= ' hidden';
					}
					$html .= '">';
					$html .= '<div class="control-label">';
					$html .= $form->getLabel($size_field);
					$html .= '</div>';
					$html .= '<div class="controls">';
					$html .= $form->getInput($size_field);
					$html .= '</div>';
					$html .= '</div>';
				}
				$html .= '</div>';
			...
			if (!empty($color_fields)) {
				...
				foreach ($color_fields as $color_field) {
					...
					if ($form->getFieldAttribute($color_field, 'type') == 'hidden') {
						$html .= ' hidden';
					}
					$html .= '">';
					$html .= '<div class="control-label">';
					$html .= $form->getLabel($color_field);
					$html .= '</div>';
					$html .= '<div class="controls">';
					$html .= $form->getInput($color_field);
					$html .= '</div>';
					$html .= '</div>';
				}
				$html .= '</div>';
			...
			if (!empty($spacing_fields)) {
				...
				foreach ($spacing_fields as $spacing_field) {
					...
					if ($form->getFieldAttribute($spacing_field, 'type') == 'hidden') {
						$html .= ' hidden';
					}
					$html .= '">';
					$html .= '<div class="control-label">';
					$html .= $form->getLabel($spacing_field);
					$html .= '</div>';
					$html .= '<div class="controls">';
					$html .= $form->getInput($spacing_field);
					$html .= '</div>';
					$html .= '</div>';
				}
				$html .= '</div>';
