jQuery(function() {
	jQuery(document).ready(function() {
		...
		RSPageBuilderHelper.initTinyMCE();
		RSPageBuilderHelper.initEditors(jQuery('.rspbld'));
		...
		jQuery(document).on('click', '#modal-element-settings .duplicate-item', function() {
			...
			element_container.find('.element-json').val(JSON.stringify(RSPageBuilderHelper.buildElementJson(element_container)), jQuery('#jform_bootstrap_version').find('label.active').prev('input').val());
		...
		jQuery(document).on('change', '#modal-element-settings .element-options .field-calendar .js-calendar select', function() {
			var element_container = jQuery('#modal-element-settings .element-container');
		...
		jQuery(document).on('keyup', '#modal-element-settings .accordion [data-name*="item_title-"], #modal-element-settings .accordion [data-name*="item_text-"], #modal-element-settings .accordion [data-name*="marker_title-"]', function() {
