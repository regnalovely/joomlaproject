...
class JFormFieldAsset extends JFormField {
    ...
    protected function getInput() {
        ...
        $doc->addScript(JURI::root().$extension_family.DS.$plugin_type.$extension_system_name.DS.'administrator'.DS.'asset.js');
        $doc->addStyleSheet(JURI::root().$extension_family.DS.$plugin_type.$extension_system_name.DS.'administrator'.DS.'asset.css');
