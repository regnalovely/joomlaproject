		...
		<thead>
			<tr>
				...
				<th id="categorylist_header_date">
					<?php if ($date == "created") :
					echo JHtml::_('grid.sort', 'COM_TAGS_'.$date.'_DATE', 'c.core_created_time', $listDirn, $listOrder);
					elseif ($date == "modified") :
					echo JHtml::_('grid.sort', 'COM_TAGS_'.$date.'_DATE', 'c.core_modified_time', $listDirn, $listOrder);
					elseif ($date == "published") :
					echo JHtml::_('grid.sort', 'COM_TAGS_'.$date.'_DATE', 'c.core_publish_up', $listDirn, $listOrder);
					endif; ?>
				</th>
				<?php endif; ?>
			</tr>
