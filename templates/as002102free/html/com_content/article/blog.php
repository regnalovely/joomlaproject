...
?>
<article class="page-item page-item__blog page-item__<?php echo $this->pageclass_sfx?>">
	<?php if ($this->params->get('show_page_heading', 1)) : ?>
	<header class="page-header">
   	<?php echo wrap_with_tag(wrap_with_span($this->escape($this->params->get('page_heading'))), $template->params->get('blog_page_heading')); ?>
	</header>
	<?php endif;
	...
	<div class="item_img img-full img-full__<?php echo htmlspecialchars($imgfloat); ?> item-image">
		...
		<time datetime="<?php echo JHtml::_('date', $this->item->publish_up, 'Y-m-d H:i'); ?>" class="item_published">
			<?php echo JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_TPL1')); ?>
		</time>
		<?php endif; ?>
	</div>
	<?php endif;
	...
	<header class="item_header">
		<?php echo '<'. $template->params->get('itemblog_item_heading') .' class="item_title">';
		...
		echo '</'. $template->params->get('itemblog_item_heading') .'>'; ?>
	</header>
	<?php endif;
