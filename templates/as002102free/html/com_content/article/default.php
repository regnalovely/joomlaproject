...
<article class="page-item page-item__<?php echo $this->pageclass_sfx?>">
	...
	<header class="item_header">
		<?php echo '<'. $template->params->get('item_item_heading') .' class="item_title">';
	...
	<figure class="item_img img-full img-full__<?php echo htmlspecialchars($imgfloat); ?> item-image">
		<img src="<?php echo htmlspecialchars($images->image_fulltext); ?>" alt="<?php echo htmlspecialchars($images->image_fulltext_alt); ?>"/>
		<?php if ($images->image_fulltext_caption): ?>
		<figure><?php echo htmlspecialchars($images->image_fulltext_caption); ?></figure>
		<?php endif; ?>
	</figure>
	<?php endif;
	if (!empty($this->item->pagination) && $this->item->pagination && !$this->item->paginationposition && !$this->item->paginationrelative):
	...
	<!-- Social Sharing -->
	<?php 
	//include_once(JPATH_ROOT . "/templates/" . $tmpl .'/includes/addthis.php');
