...
<div class="system-unpublished">
	...
	<header class="item_header">
		<?php echo '<'. $template->params->get('featured_item_heading') .' class="item_title">';
			if ($params->get('link_titles') && $params->get('access-view')) : ?>
			<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid)); ?>"> 
			<?php echo  wrap_with_span($this->escape($this->item->title)); ?></a>
			<?php else :
			echo  wrap_with_span($this->escape($this->item->title));
			endif;
		echo '</'. $template->params->get('featured_item_heading') .'>'; ?>
	</header>
	<?php endif;
