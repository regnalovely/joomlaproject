...
<form id="finder-search" action="<?php echo JRoute::_($this->query->toURI()); ?>" method="get" class="form-inline">
	...
	<fieldset class="word">
		...
		<div class="control-group">
			...
			<button name="Search" type="submit" class="btn btn-primary"><i class="fa fa-search icon-white"></i> <?php echo JText::_('JSEARCH_FILTER_SUBMIT');?></button>
			<?php else: ?>
			<button name="Search" type="submit" class="btn btn-primary disabled"><i class="fa fa-search icon-white"></i> <?php echo JText::_('JSEARCH_FILTER_SUBMIT');?></button>
			<?php endif; ?>
		</div>

		<?php if ($this->params->get('show_advanced', 1)): ?>
		<a href="#advancedSearch" data-toggle="collapse" class="btn"><i class="fa fa-list"></i> <?php echo JText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?></a>
		<?php endif; ?>
	</fieldset>
