...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	<div class="btn-toolbar">
		...
		<div class="btn-group pull-left">
			<button name="Search" onclick="this.form.submit()" class="btn btn-primary" title="<?php echo JText::_('COM_SEARCH_SEARCH');?>"><i class="fa fa-search"></i></button>
		</div>
	...
	<fieldset class="phrases">
  	<?php echo wrap_with_tag(wrap_with_span($this->escape(JText::_('COM_SEARCH_FOR'))), $template->params->get('category_item_heading')); ?>
	...
	<fieldset class="only">
  	<?php echo wrap_with_tag(wrap_with_span($this->escape(JText::_('COM_SEARCH_SEARCH_ONLY'))), $template->params->get('category_item_heading'));
