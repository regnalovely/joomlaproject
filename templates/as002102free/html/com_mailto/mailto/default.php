...
<div id="mailto-window">
	<div class="mailto-close">
		<a href="javascript: void window.close()" title="<?php echo JText::_('COM_MAILTO_CLOSE_WINDOW'); ?>" class="btn">
		<i class="fa fa-times-circle"></i> <span><?php echo JText::_('COM_MAILTO_CLOSE_WINDOW'); ?> </span></a>
	</div>
	...
	<form action="<?php echo JUri::base() ?>index.php" id="mailtoForm" method="post">
		...
		<p>
			...
			<button class="btn btn-info" onclick="window.close();return false;"><?php echo JText::_('COM_MAILTO_CANCEL'); ?></button>
		</p>
