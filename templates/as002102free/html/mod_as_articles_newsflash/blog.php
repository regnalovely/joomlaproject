...
?>
<div class="mod-newsflash-adv mod-newsflash-adv__<?php echo $moduleclass_sfx; ?> cols-<?php echo $columns; ?> from-blog" id="module_<?php echo $module->id; ?>">
  ...
  <?php endif;
  if($params->get('masonry')) : ?>
  <div class="masonry" id="mod-newsflash-adv__masonry<?php echo $module->id; ?>">
  <?php else: ?>
  <div>
  <?php endif;
  for ($i = 0, $n; $i < $n; $i ++) :
  ...
  <article class="<?php echo $spanClass; ?> item item_num<?php echo $i; ?> item__module  <?php echo $class; ?>" id="item_<?php echo $item->id; ?>">
	  <?php require JModuleHelper::getLayoutPath('mod_as_articles_newsflash', '_blog'); ?>
  </article>
  <?php endfor; ?>
  </div> 
