...
?>
<div class="mod-newsflash-adv mod-newsflash-adv__<?php echo $moduleclass_sfx; ?> cols-<?php echo $columns; ?> achievements" id="module_<?php echo $module->id; ?>">
  ...
  <article class="<?php echo $spanClass; ?> item item_num<?php echo $i; ?> item__module  <?php echo $class; ?>" id="item_<?php echo $item->id; ?>">
    <?php require JModuleHelper::getLayoutPath('mod_as_articles_newsflash', '_achievements'); ?>
  </article>
  <?php endfor; ?>
  </div> 
