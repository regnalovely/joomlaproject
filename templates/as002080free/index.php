...
<body class="<?php echo $option . " view-" . $view . " task-" . $task . " itemid-" . $itemid . " body__" . $pageClass;?>">
    ...
    <div class="wrapper">
    	...
    	<div id="main-container">
			...
			<?php if ($this->countModules('as-position-6') && !$hideByView && !$hideByOption): ?>
            <div id="featured-row">
                <div class="container">
                    <div class="row">
            ...
            <?php if ($this->countModules('as-position-7') && !$hideByView && !$hideByOption): ?>
                ...
                <div class="container">
                    <div class="content-inner row">
                        ...
                        <div id="component" class="span<?php echo $mainContentWidth; ?>">
                            ...
                            <?php if ($this->countModules('as-position-20') && !$hideByView && !$hideByOption): ?>
                            ...
                            <?php if ($this->countModules('as-position-21') && !$hideByView && !$hideByOption): ?>
                            ...
                            <?php if ($this->countModules('as-position-22') && !$hideByView && !$hideByOption): ?>
            ...
            <?php if ($this->countModules('as-position-23') && !$hideByView && !$hideByOption): ?>
            ...
            <?php if ($this->countModules('as-position-24') && !$hideByView && !$hideByOption): ?>
